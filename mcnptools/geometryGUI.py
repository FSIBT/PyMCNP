# -*- coding: utf-8 -*-
"""
Created on Wed Jan 13 10:46:18 2021
...
soil = bg.Geometry(color="blue", name="Soil", h_menu=0,
                  fig=fig, ax_3d=ax_3d, ax_menu=ax_menu, soil=True)
soil.make_object(x0=0, y0=0, z0=-200, height=150, radius=200, axis="z")

png = bg.Geometry(color="green", name="PNG (TR1)", h_menu=0.89,
                  fig=fig, ax_3d=ax_3d, ax_menu=ax_menu)
png.make_object(x0=0, y0=-30, z0=0, height=30, radius=10, axis="y")

rover = bg.Geometry(color="black", name="Rover (TR2)", h_menu=0.65,
                    fig=fig, ax_3d=ax_3d, ax_menu=ax_menu)
rover.make_object(x0=30, y0=-50, z0=0, height=100, radius=12, axis="y")

detector = bg.Geometry(color="red", name="Detector (TR3)", h_menu=0.42,
                      fig=fig, ax_3d=ax_3d, ax_menu=ax_menu)
