        ...
        EXAMPLES_VALID = [
            {
                ...
                'f1': _utils.string.type.REAL,
                'f2': _utils.string.type.REAL,
                'f3': _utils.string.type.REAL,
            },
            {'suffix': 5, 'designator': _utils.string.type.DESIGNATOR, 'x1': 3.1, 'y1': 3.1, 'z1': 3.1, 'ro': 0, 'x2': 3.1, 'y2': 3.1, 'z2': 3.1, 'f1': 3.1, 'f2': 3.1, 'f3': 3.1},
            {
                ...
                'f1': _utils.ast.type.REAL,
                'f2': _utils.ast.type.REAL,
                'f3': _utils.ast.type.REAL,
            },
        ]
        EXAMPLES_INVALID = [
            {
