...
class Test_Cell:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'number': consts.string.types.INTEGER, 'material': consts.string.types.INTEGER, 'density': consts.string.types.REAL, 'geometry': consts.string.types.GEOMETRY, 'options': None},
        ]
        EXAMPLES_INVALID = [
