...
class Test_DxcBuilder:
    class TestBuild(classes.Test_Build):
        element = pymcnp.inp.like.DxcBuilder
        EXAMPLES_VALID = [
            ...
            {'suffix': consts.ast.type.INTEGER, 'designator': consts.ast.type.DESIGNATOR, 'probability': pymcnp.types.Real(0.8)},
        ]
        EXAMPLES_INVALID = [
            {'suffix': None, 'designator': consts.string.type.DESIGNATOR, 'probability': '0.8'},
            {'suffix': consts.string.type.INTEGER, 'designator': None, 'probability': '0.8'},
