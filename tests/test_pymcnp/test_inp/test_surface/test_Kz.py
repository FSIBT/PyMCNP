...
class Test_Kz:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'z': consts.ast.type.REAL, 't_squared': consts.ast.type.REAL, 'plusminus_1': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'z': None, 't_squared': consts.ast.type.REAL, 'plusminus_1': consts.ast.type.REAL},
            {'z': consts.ast.type.REAL, 't_squared': None, 'plusminus_1': consts.ast.type.REAL},
            {'z': consts.ast.type.REAL, 't_squared': consts.ast.type.REAL, 'plusminus_1': None},
        ]
