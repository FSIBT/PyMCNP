...
class Test_Ky:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'y': consts.ast.type.REAL, 't_squared': consts.ast.type.REAL, 'plusminus_1': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'y': None, 't_squared': consts.ast.type.REAL, 'plusminus_1': consts.ast.type.REAL},
            {'y': consts.ast.type.REAL, 't_squared': None, 'plusminus_1': consts.ast.type.REAL},
            {'y': consts.ast.type.REAL, 't_squared': consts.ast.type.REAL, 'plusminus_1': None},
        ]
