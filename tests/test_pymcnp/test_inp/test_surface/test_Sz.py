...
class Test_Sz:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'z': consts.ast.type.REAL, 'r': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [{'z': None, 'r': consts.ast.type.REAL}, {'z': consts.ast.type.REAL, 'r': None}]
