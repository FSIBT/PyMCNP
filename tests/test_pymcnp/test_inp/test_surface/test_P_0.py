...
class Test_P_0:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'a': consts.ast.type.REAL, 'b': consts.ast.type.REAL, 'c': consts.ast.type.REAL, 'd': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'a': None, 'b': consts.ast.type.REAL, 'c': consts.ast.type.REAL, 'd': consts.ast.type.REAL},
            {'a': consts.ast.type.REAL, 'b': None, 'c': consts.ast.type.REAL, 'd': consts.ast.type.REAL},
            {'a': consts.ast.type.REAL, 'b': consts.ast.type.REAL, 'c': None, 'd': consts.ast.type.REAL},
            {'a': consts.ast.type.REAL, 'b': consts.ast.type.REAL, 'c': consts.ast.type.REAL, 'd': None},
        ]
