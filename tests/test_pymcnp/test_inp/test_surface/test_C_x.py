...
class Test_C_x:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'r': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'y': None, 'z': consts.ast.type.REAL, 'r': consts.ast.type.REAL},
            {'y': consts.ast.type.REAL, 'z': None, 'r': consts.ast.type.REAL},
            {'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'r': None},
        ]
