...
class Test_Sph:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'vx': consts.ast.type.REAL, 'vy': consts.ast.type.REAL, 'vz': consts.ast.type.REAL, 'r': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'vx': None, 'vy': consts.ast.type.REAL, 'vz': consts.ast.type.REAL, 'r': consts.ast.type.REAL},
            {'vx': consts.ast.type.REAL, 'vy': None, 'vz': consts.ast.type.REAL, 'r': consts.ast.type.REAL},
            {'vx': consts.ast.type.REAL, 'vy': consts.ast.type.REAL, 'vz': None, 'r': consts.ast.type.REAL},
            {'vx': consts.ast.type.REAL, 'vy': consts.ast.type.REAL, 'vz': consts.ast.type.REAL, 'r': None},
        ]
