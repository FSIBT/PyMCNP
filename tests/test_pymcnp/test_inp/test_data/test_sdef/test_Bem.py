...
class Test_Bem:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'exn': consts.ast.type.REAL, 'eyn': consts.ast.type.REAL, 'bml': consts.ast.type.REAL}]
        EXAMPLES_INVALID = [
            {'exn': None, 'eyn': consts.ast.type.REAL, 'bml': consts.ast.type.REAL},
            {'exn': consts.ast.type.REAL, 'eyn': None, 'bml': consts.ast.type.REAL},
            {'exn': consts.ast.type.REAL, 'eyn': consts.ast.type.REAL, 'bml': None},
        ]
