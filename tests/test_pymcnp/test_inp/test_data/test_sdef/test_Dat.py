...
class Test_Dat:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'month': consts.ast.type.INTEGER, 'day': consts.ast.type.INTEGER, 'year': consts.ast.type.INTEGER}]
        EXAMPLES_INVALID = [
            {'month': None, 'day': consts.ast.type.INTEGER, 'year': consts.ast.type.INTEGER},
            {'month': consts.ast.type.INTEGER, 'day': None, 'year': consts.ast.type.INTEGER},
            {'month': consts.ast.type.INTEGER, 'day': consts.ast.type.INTEGER, 'year': None},
        ]
