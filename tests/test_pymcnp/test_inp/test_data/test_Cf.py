...
class Test_Cf:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'numbers': [consts.ast.type.INTEGER]}]
        EXAMPLES_INVALID = [{'suffix': None, 'numbers': [consts.ast.type.INTEGER]}, {'suffix': consts.ast.type.INTEGER, 'numbers': None}]
