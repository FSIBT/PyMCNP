...
class Test_Ds_2:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'vss': [consts.ast.type.INDEPENDENTDEPENDENT]}]
        EXAMPLES_INVALID = [{'suffix': None, 'vss': [consts.ast.type.INDEPENDENTDEPENDENT]}, {'suffix': consts.ast.type.INTEGER, 'vss': None}]
