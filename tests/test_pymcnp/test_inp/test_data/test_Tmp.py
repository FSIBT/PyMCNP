...
class Test_Tmp:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'temperatures': [consts.ast.type.REAL]}, {'suffix': None, 'temperatures': [consts.ast.type.REAL]}]
        EXAMPLES_INVALID = [{'suffix': consts.ast.type.INTEGER, 'temperatures': None}]
