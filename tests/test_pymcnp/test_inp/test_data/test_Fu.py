...
class Test_Fu:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'suffix': consts.ast.type.INTEGER, 'bounds': [consts.ast.type.REAL], 'nt': None, 'c': pymcnp.types.String('c')},
            {'suffix': consts.ast.type.INTEGER, 'bounds': [consts.ast.type.REAL], 'nt': pymcnp.types.String('nt'), 'c': None},
        ]
        EXAMPLES_INVALID = [
            {'suffix': None, 'bounds': [consts.ast.type.REAL], 'nt': pymcnp.types.String('nt'), 'c': pymcnp.types.String('c')},
            {'suffix': consts.ast.type.INTEGER, 'bounds': None, 'nt': pymcnp.types.String('nt'), 'c': pymcnp.types.String('c')},
        ]
