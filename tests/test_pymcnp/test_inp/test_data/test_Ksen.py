...
class Test_Ksen:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'suffix': consts.ast.type.INTEGER, 'sen': consts.ast.type.STRING, 'options': None},
        ]
        EXAMPLES_INVALID = [
            {'suffix': None, 'sen': consts.ast.type.STRING, 'options': [consts.ast.inp.data.ksen.CONSTRAIN]},
            {'suffix': consts.ast.type.INTEGER, 'sen': None, 'options': [consts.ast.inp.data.ksen.CONSTRAIN]},
        ]
...
class Test_KsenBuilder:
    class TestBuild(classes.Test_Build):
        ...
        EXAMPLES_VALID = [
            ...
            {'suffix': 1, 'sen': consts.string.type.STRING, 'options': [consts.builder.inp.data.ksen.CONSTRAIN]},
            {'suffix': consts.ast.type.INTEGER, 'sen': consts.ast.type.STRING, 'options': [consts.ast.inp.data.ksen.CONSTRAIN]},
