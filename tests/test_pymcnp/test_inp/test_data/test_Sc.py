...
class Test_Sc:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'comment': [consts.ast.type.STRING]}]
        EXAMPLES_INVALID = [{'suffix': None, 'comment': [consts.ast.type.STRING]}, {'suffix': consts.ast.type.INTEGER, 'comment': None}]
