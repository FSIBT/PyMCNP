...
class Test_Ds_1:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'ijs': [consts.ast.type.INDEPENDENTDEPENDENT]}]
        EXAMPLES_INVALID = [{'suffix': None, 'ijs': [consts.ast.type.INDEPENDENTDEPENDENT]}, {'suffix': consts.ast.type.INTEGER, 'ijs': None}]
