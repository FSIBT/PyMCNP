...
class Test_Tr_4:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'prefix': None, 'suffix': consts.ast.type.INTEGER, 'x': consts.ast.type.REAL, 'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'system': consts.ast.type.INTEGER},
            {'prefix': pymcnp.types.String('*'), 'suffix': consts.ast.type.INTEGER, 'x': consts.ast.type.REAL, 'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'system': None},
        ]
        EXAMPLES_INVALID = [
            {'prefix': pymcnp.types.String('*'), 'suffix': None, 'x': consts.ast.type.REAL, 'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'system': consts.ast.type.INTEGER},
            {'prefix': pymcnp.types.String('*'), 'suffix': consts.ast.type.INTEGER, 'x': None, 'y': consts.ast.type.REAL, 'z': consts.ast.type.REAL, 'system': consts.ast.type.INTEGER},
            {'prefix': pymcnp.types.String('*'), 'suffix': consts.ast.type.INTEGER, 'x': consts.ast.type.REAL, 'y': None, 'z': consts.ast.type.REAL, 'system': consts.ast.type.INTEGER},
            {'prefix': pymcnp.types.String('*'), 'suffix': consts.ast.type.INTEGER, 'x': consts.ast.type.REAL, 'y': consts.ast.type.REAL, 'z': None, 'system': consts.ast.type.INTEGER},
        ]
