...
class Test_Xs:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'suffix': consts.ast.type.INTEGER, 'weight_ratios': [consts.ast.type.SUBSTANCE]}]
        EXAMPLES_INVALID = [{'suffix': None, 'weight_ratios': [consts.ast.type.SUBSTANCE]}, {'suffix': consts.ast.type.INTEGER, 'weight_ratios': None}]
