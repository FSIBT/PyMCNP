...
class Test_Cosyp:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'pre': consts.ast.type.INTEGER, 'axsh': consts.ast.type.INTEGER, 'axsv': consts.ast.type.INTEGER, 'emaps': [consts.ast.type.REAL]}]
        EXAMPLES_INVALID = [
            {'pre': None, 'axsh': consts.ast.type.INTEGER, 'axsv': consts.ast.type.INTEGER, 'emaps': [consts.ast.type.REAL]},
            {'pre': consts.ast.type.INTEGER, 'axsh': None, 'axsv': consts.ast.type.INTEGER, 'emaps': [consts.ast.type.REAL]},
            {'pre': consts.ast.type.INTEGER, 'axsh': consts.ast.type.INTEGER, 'axsv': None, 'emaps': [consts.ast.type.REAL]},
            {'pre': consts.ast.type.INTEGER, 'axsh': consts.ast.type.INTEGER, 'axsv': consts.ast.type.INTEGER, 'emaps': None},
        ]
