...
class Test_Si_1:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'suffix': consts.ast.type.INTEGER, 'option': None, 'information': [consts.ast.type.REAL]},
        ]
        EXAMPLES_INVALID = [
            {'suffix': None, 'option': consts.ast.type.STRING, 'information': [consts.ast.type.REAL]},
