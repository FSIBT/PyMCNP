...
class Test_Contour:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'cmin': consts.ast.type.REAL, 'cmax': consts.ast.type.REAL, 'cstep': consts.ast.type.REAL, 'options': None},
        ]
        EXAMPLES_INVALID = [
            {'cmin': None, 'cmax': consts.ast.type.REAL, 'cstep': consts.ast.type.REAL, 'options': [consts.ast.inp.data.mplot.contour.ALL]},
            {'cmin': consts.ast.type.REAL, 'cmax': None, 'cstep': consts.ast.type.REAL, 'options': [consts.ast.inp.data.mplot.contour.ALL]},
            {'cmin': consts.ast.type.REAL, 'cmax': consts.ast.type.REAL, 'cstep': None, 'options': [consts.ast.inp.data.mplot.contour.ALL]},
        ]
...
class Test_ContourBuilder:
    class TestBuild(classes.Test_Build):
        ...
        EXAMPLES_VALID = [
            ...
            {'cmin': 3.1, 'cmax': 3.1, 'cstep': 3.1, 'options': [consts.builder.inp.data.mplot.contour.ALL]},
            {'cmin': consts.ast.type.REAL, 'cmax': consts.ast.type.REAL, 'cstep': consts.ast.type.REAL, 'options': [consts.ast.inp.data.mplot.contour.ALL]},
