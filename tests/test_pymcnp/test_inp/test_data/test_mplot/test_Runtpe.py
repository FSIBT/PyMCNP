...
class Test_Runtpe:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [{'filename': consts.ast.type.STRING, 'n': consts.ast.type.INTEGER}, {'filename': consts.ast.type.STRING, 'n': None}]
        EXAMPLES_INVALID = [{'filename': None, 'n': consts.ast.type.INTEGER}]
