...
class Test_Cell(classes.Test_Nonterminal):
    element = pymcnp.inp.card.Cell
    EXAMPLES_VALID = [
        '1 1 3.1 1 (2:(+3 -4) #5) imp:@=1',
        '2 like 1 but imp:@=2',
        # 3.2
        ...
        '10 16 -4.2 1 -2 3 IMP:N=4 IMP:P=8 EXT:N=-0.4X',
    ...
    EXAMPLES_INVALID = [
        ...
        '1 1 #(2.3)',
        '1 0 #(2.3) rho=3.4',
        '-1 like 2 but rho=-5.2',
        '1 like -2 but rho=-5.2',
        'hello',
    ]

    def test___invert__(self, cell_a: pymcnp.inp.card.Cell) -> None:
        ~cell_a
