...
class Test_Rec:
    class Test_Init(classes.Test_Init):
        ...
        EXAMPLES_VALID = [
            ...
            {'prefix': '*', 'number': 1, 'transform': 1, 'vx': 3.1, 'vy': 3.1, 'vz': 3.1, 'hx': 3.1, 'hy': 3.1, 'hz': 3.1, 'v1x': 3.1, 'v1y': 3.1, 'v1z': 3.1, 'v2x': 3.1, 'v2y': 3.1, 'v2z': 3.1},
            {
    ...
    class Test_Mcnp(classes.Test_Mcnp):
        element = pymcnp.inp.Rec
        EXAMPLES_VALID = [consts.string.inp.REC]
        EXAMPLES_INVALID = ['hello']

    class Test_Show(classes.Test_Show):
        element = pymcnp.inp.Rec
        EXAMPLES = [consts.string.inp.REC]

    class Test_Operations(classes.Test_Operations):
        EXAMPLES = [(consts.ast.inp.REC, consts.ast.inp.REC)]
