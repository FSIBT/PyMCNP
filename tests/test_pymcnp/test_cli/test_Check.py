...
class Test_Main:
    class Test_Main:
        def test_valid(self):
            ...
            subprocess.run(['pymcnp', 'check', str(pathlib.Path(__file__).parent.parent.parent.parent / 'files' / 'inp' / 'valid_C.i'), '--fix'])

        def test_invalid(self):
            subprocess.run(['pymcnp', 'check', str(pathlib.Path(__file__).parent.parent.parent.parent / 'files' / 'inp' / 'invalid_A.i')])
