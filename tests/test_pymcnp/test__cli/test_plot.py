...
class Test_Main:
    class Test_Main:
        def test_valid(self):
            os.system(f'pymcnp plot {pathlib.Path(__file__).parent.parent.parent.parent / "files" / "outp" / "example_00.outp"} 1')
            os.system(f'pymcnp plot {pathlib.Path(__file__).parent.parent.parent.parent / "files" / "outp" / "example_00.outp"} 1 --pdf')
