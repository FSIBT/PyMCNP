        ...
        EXAMPLES_VALID = [
            {
                ...
                'cells': {'1': consts.string.inp.CELL},
                'cells_comments': [consts.string.inp.COMMENT],
                'surfaces': {'99': consts.string.inp.SURFACE},
                'surfaces_comments': [consts.string.inp.COMMENT],
                'data': {'nps': consts.string.inp.DATA},
            ...
            {
                'title': consts.string.type.STRING,
                'cells': {'1': consts.builder.inp.CELL},
                'cells_comments': [consts.builder.inp.COMMENT],
                'surfaces': {'99': consts.builder.inp.SURFACE},
                'surfaces_comments': [consts.builder.inp.COMMENT],
                'data': {'vol': consts.builder.inp.DATA},
            ...
            },
            {
                ...
                'cells': {'1': consts.ast.inp.CELL},
                'cells_comments': [consts.ast.inp.COMMENT],
                'surfaces': {'99': consts.ast.inp.SURFACE},
                'surfaces_comments': [consts.ast.inp.COMMENT],
                'data': {'nps': consts.ast.inp.DATA},
