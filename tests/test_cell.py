...
class Test_CellKeyword:
    ...
    def test_valid(self):
        assert pymcnp.inp.Cell.CellOption.CellKeyword("imp") == pymcnp.inp.Cell.CellOption.CellKeyword.IMPORTANCE
        assert pymcnp.inp.Cell.CellOption.CellKeyword("vol") == pymcnp.inp.Cell.CellOption.CellKeyword.VOLUME
        assert pymcnp.inp.Cell.CellOption.CellKeyword("pwt") == pymcnp.inp.Cell.CellOption.CellKeyword.PHOTON_WEIGHT
        assert pymcnp.inp.Cell.CellOption.CellKeyword("ext") == pymcnp.inp.Cell.CellOption.CellKeyword.EXPONENTIAL_TRANSFORM
        assert pymcnp.inp.Cell.CellOption.CellKeyword("fcl") == pymcnp.inp.Cell.CellOption.CellKeyword.FORCED_COLLISION
        assert pymcnp.inp.Cell.CellOption.CellKeyword("wwn") == pymcnp.inp.Cell.CellOption.CellKeyword.WEIGHT_WINDOW_BOUNDS
        assert pymcnp.inp.Cell.CellOption.CellKeyword("dxc") == pymcnp.inp.Cell.CellOption.CellKeyword.DXTRAN_CONTRIBUTION
        assert pymcnp.inp.Cell.CellOption.CellKeyword("nonu") == pymcnp.inp.Cell.CellOption.CellKeyword.FISSION_TURNOFF
        assert pymcnp.inp.Cell.CellOption.CellKeyword("pd") == pymcnp.inp.Cell.CellOption.CellKeyword.DETECTOR_CONTRIBUTION
        assert pymcnp.inp.Cell.CellOption.CellKeyword("tmp") == pymcnp.inp.Cell.CellOption.CellKeyword.GAS_THERMAL_TEMPERATURE
        assert pymcnp.inp.Cell.CellOption.CellKeyword("u") == pymcnp.inp.Cell.CellOption.CellKeyword.UNIVERSE
        assert (
            pymcnp.inp.Cell.CellOption.CellKeyword("trcl") == pymcnp.inp.Cell.CellOption.CellKeyword.COORDINATE_TRANSFORMATION
        )
        assert (
            pymcnp.inp.Cell.CellOption.CellKeyword("*trcl")
            == pymcnp.inp.Cell.CellOption.CellKeyword.COORDINATE_TRANSFORMATION_ANGLE
        )
        assert pymcnp.inp.Cell.CellOption.CellKeyword("lat") == pymcnp.inp.Cell.CellOption.CellKeyword.LATTICE
        assert pymcnp.inp.Cell.CellOption.CellKeyword("fill") == pymcnp.inp.Cell.CellOption.CellKeyword.FILL
        assert pymcnp.inp.Cell.CellOption.CellKeyword("*fill") == pymcnp.inp.Cell.CellOption.CellKeyword.FILL_ANGLE
        assert pymcnp.inp.Cell.CellOption.CellKeyword("elpt") == pymcnp.inp.Cell.CellOption.CellKeyword.ENERGY_CUTOFF
        assert pymcnp.inp.Cell.CellOption.CellKeyword("cosy") == pymcnp.inp.Cell.CellOption.CellKeyword.COSY
        assert pymcnp.inp.Cell.CellOption.CellKeyword("bflcl") == pymcnp.inp.Cell.CellOption.CellKeyword.BFIELD
        assert pymcnp.inp.Cell.CellOption.CellKeyword("unc") == pymcnp.inp.Cell.CellOption.CellKeyword.UNCOLLIDED_SECONDARIES
...
class Test_CellOption:
    ...
    INVALID_VALUE_EXAMPLES = [
        ...
        (pymcnp.inp.Cell.CellOption.CellKeyword("u"), pymcnp.utils.types.McnpInteger(-100_000_000), _, _),
        (pymcnp.inp.Cell.CellOption.CellKeyword("trcl"), pymcnp.utils.types.McnpInteger(1000), _, _),
    ...
    INVALID_DESGINATOR_EXAMPLES = [
        (pymcnp.inp.Cell.CellOption.CellKeyword("imp"), pymcnp.utils.types.McnpInteger(1), None, None),
        (pymcnp.inp.Cell.CellOption.CellKeyword("ext"), pymcnp.utils.types.McnpInteger(1), None, None),
        (pymcnp.inp.Cell.CellOption.CellKeyword("fcl"), pymcnp.utils.types.McnpReal(-0.9), None, None),
        (
            pymcnp.inp.Cell.CellOption.CellKeyword("wwn"),
            pymcnp.utils.types.McnpReal(-1.0),
            pymcnp.utils.types.McnpInteger(1),
        ...
        (pymcnp.inp.Cell.CellOption.CellKeyword("elpt"), pymcnp.utils.types.McnpReal(1.33), None, None),
        (pymcnp.inp.Cell.CellOption.CellKeyword("unc"), pymcnp.utils.types.McnpInteger(1), None, None),
    ]
    ...
    def test_invalid_keyword(self):
        for keyword, value, suffix, designator in self.INVALID_KEYWORD_EXAMPLES:
            ...
            assert err.value.code == pymcnp.utils.errors.MCNPSemanticCodes.INVALID_CELL_OPTION_KEYWORD
    ...
    def test_invalid_suffix(self):
        for keyword, value, suffix, designator in self.INVALID_SUFFIX_EXAMPLES:
            ...
            assert err.value.code == pymcnp.utils.errors.MCNPSemanticCodes.INVALID_CELL_OPTION_SUFFIX
    ...
    def test_invalid_designator(self):
        for keyword, value, suffix, designator in self.INVALID_DESGINATOR_EXAMPLES:
            ...
            assert err.value.code == pymcnp.utils.errors.MCNPSemanticCodes.INVALID_CELL_OPTION_DESIGNATOR
...
class Test_Cell:
    ...
    INVALID_DENSITY_EXAMPLES = [
        ...
        (pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpReal(-0.232), _, _, _),
        (pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpReal(-3.232), _, _, _),
    ]

    INVALID_GEOMETRY_EXAMLPES = [
        (pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpInteger(1), pymcnp.utils.types.McnpReal(3.232), None, _),
    ]
    ...
    INVALID_OPTIONS_EXAMPLES = [
        ...
        (
            ...
            pymcnp.utils.types.McnpReal(3.232),
            pymcnp.inp.Cell.CellGeometry("#1"),
            (pymcnp.inp.Cell.CellOption.from_mcnp("imp:n=1"), pymcnp.inp.Cell.CellOption.from_mcnp("vol=3.4")),
        ),
    ]
