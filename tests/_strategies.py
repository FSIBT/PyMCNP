...
def mcnp_surfaces(draw):
	...
	return draw(st.sampled_from([draw(mcnp_surface_planeGenerals()), draw(mcnp_surface_planeNormalXs()), draw(mcnp_surface_planeNormalYs()), draw(mcnp_surface_planeNormalZs()), draw(mcnp_surface_sphereOrigins()), draw(mcnp_surface_sphereGenerals()), draw(mcnp_surface_sphereNormalXs()), draw(mcnp_surface_sphereNormalYs()), draw(mcnp_surface_sphereNormalZs()), draw(mcnp_surface_cylinderParallelXs()), draw(mcnp_surface_cylinderParallelYs()), draw(mcnp_surface_cylinderParallelZs()), draw(mcnp_surface_cylinderOnXs()), draw(mcnp_surface_cylinderOnYs()), draw(mcnp_surface_cylinderOnZs()), draw(mcnp_surface_coneParallelXs()), draw(mcnp_surface_coneParallelYs()), draw(mcnp_surface_coneParallelZs()), draw(mcnp_surface_coneOnXs()), draw(mcnp_surface_coneOnYs()), draw(mcnp_surface_coneOnZs()), draw(mcnp_surface_quadraticSpecials()), draw(mcnp_surface_quadraticGenerals()), draw(mcnp_surface_torusParallelXs()), draw(mcnp_surface_torusParallelYs()), draw(mcnp_surface_torusParallelZs()), draw(mcnp_surface_surfaceXs()), draw(mcnp_surface_surfaceYs()), draw(mcnp_surface_surfaceZs()), draw(mcnp_surface_boxs()), draw(mcnp_surface_parallelepipeds()), draw(mcnp_surface_spheres()), draw(mcnp_surface_cylinderCirculars()), draw(mcnp_surface_hexagonalPrisms()), draw(mcnp_surface_cylinderEllipticals()), draw(mcnp_surface_coneTruncateds()), draw(mcnp_surface_ellipsoids()), draw(mcnp_surface_wedges()), draw(mcnp_surface_polyhedrons())]))
...
def mcnp_surface_planePoints(draw):
	...
	return (
		...
		'p',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
...
def mcnp_surface_planeGenerals(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'p',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
...
def mcnp_surface_coneParallelXs(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'k/x',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
...
def mcnp_surface_quadraticSpecials(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'sq',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
...
def mcnp_surface_torusParallelXs(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'tx',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
	...
	return draw(st.sampled_from([
		(
 		...
 		(
			...
			draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
			'box', 
			[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())],
 		),
 	]))
...
def mcnp_surface_cylinderCirculars(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'rcc',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())]
	)
...
def mcnp_surface_hexagonalPrisms(draw):
	...
	return draw(st.sampled_from([
		...
		(
			...
			draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
			'rhp', 
			[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())],
 		),
 	]))
...
def mcnp_surface_coneTruncateds(draw):
	...
	return (
		...
		draw(fortran_integers(lambda i: -99_999_999 <= i <= 999)),
		'trc',
		[draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals()), draw(fortran_reals())],
	)
