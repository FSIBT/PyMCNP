...
class Fill_1(_option.CellOption):
    """
    ...
    _REGEX = re.compile(rf'\A([*])?fill( {types.Integer._REGEX.pattern[2:-2]})( {types.Transformation_0._REGEX.pattern[2:-2]}| [(]{types.Transformation_0._REGEX.pattern[2:-2]}[)])?\Z', re.IGNORECASE)

    def __init__(self, universe: str | int | types.Integer, prefix: str | types.String = None, transformation: str | types.Transformation_0 = None):
        """
        Initializes `Fill_1`.
        ...
        self.transformation: types.Transformation_0 = transformation
    ...
    @property
    def transformation(self) -> types.Transformation_0:
        """
    ...
    def transformation(self, transformation: str | types.Transformation_0) -> None:
        """
        Sets `transformation`.
        ...
        if transformation is not None:
            if isinstance(transformation, types.Transformation_0):
                transformation = transformation
            elif isinstance(transformation, str):
                transformation = types.Transformation_0.from_mcnp(transformation)

        self._transformation: types.Transformation_0 = transformation
