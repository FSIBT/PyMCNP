...
class Fill_2(_option.LikeOption):
    """
    ...
    _REGEX = re.compile(rf'\A([*])?fill( {types.Integer._REGEX.pattern[2:-2]})( {types.Transformation_1._REGEX.pattern[2:-2]}| [(]{types.Transformation_1._REGEX.pattern[2:-2]}[)])?\Z', re.IGNORECASE)

    def __init__(self, universe: str | int | types.Integer, prefix: str | types.String = None, transformation: str | types.Transformation_1 = None):
        """
        Initializes `Fill_2`.
