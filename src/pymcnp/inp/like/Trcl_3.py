...
class Trcl_3(_option.LikeOption):
    """
    ...
    _REGEX = re.compile(rf'\A([*])?trcl( {types.Transformation_2._REGEX.pattern[2:-2]})\Z', re.IGNORECASE)

    def __init__(self, transformation: str | types.Transformation_2, prefix: str | types.String = None):
        """
        Initializes `Trcl_3`.
