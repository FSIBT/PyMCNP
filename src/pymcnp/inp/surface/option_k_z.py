...
class SurfaceOption_K_z(_option.SurfaceOption_, keyword='k/z'):
    """
    Represents INP surface card k/z options.
    ...
    _REGEX = re.compile(r'\Ak/z( \S+)( \S+)( \S+)( \S+)( \S+)\Z')
    ...
    def from_mcnp(source: str):
        """
        Generates ``SurfaceOption_K_z`` from INP.
        ...
        tokens = SurfaceOption_K_z._REGEX.match(source)
        ...
        return SurfaceOption_K_z(x, y, z, t_squared, plusminus_1)
