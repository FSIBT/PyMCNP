...
class DataOption_Dbcn(_option.DataOption_, keyword='dbcn'):
    """
    Represents INP data card dbcn options.
    ...
    _REGEX = re.compile(
        r'\Adbcn( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)( \S+)\Z'
    )
    ...
    def from_mcnp(source: str):
        """
        Generates ``DataOption_Dbcn`` from INP.
        ...
        x3 = types.Integer.from_mcnp(tokens[3])
        x4 = types.Integer.from_mcnp(tokens[4])
        x5 = types.Integer.from_mcnp(tokens[5])
        x6 = types.Integer.from_mcnp(tokens[6])
        x7 = types.Integer.from_mcnp(tokens[7])
        x8 = types.Integer.from_mcnp(tokens[8])
        x9 = types.Integer.from_mcnp(tokens[9])
        x10 = types.Integer.from_mcnp(tokens[10])
        x11 = types.Integer.from_mcnp(tokens[11])
        x12 = types.Integer.from_mcnp(tokens[12])
        x13 = types.Integer.from_mcnp(tokens[13])
        x14 = types.Integer.from_mcnp(tokens[14])
        x15 = types.Integer.from_mcnp(tokens[15])
        x16 = types.Integer.from_mcnp(tokens[16])
        x17 = types.Integer.from_mcnp(tokens[17])
        x18 = types.Integer.from_mcnp(tokens[18])
        x19 = types.Integer.from_mcnp(tokens[19])
        x20 = types.Integer.from_mcnp(tokens[20])
        x21 = types.Integer.from_mcnp(tokens[21])
        x22 = types.Integer.from_mcnp(tokens[22])
        x23 = types.Integer.from_mcnp(tokens[23])
        x24 = types.Integer.from_mcnp(tokens[24])
        x25 = types.Integer.from_mcnp(tokens[25])
        x26 = types.Integer.from_mcnp(tokens[26])
        x27 = types.Integer.from_mcnp(tokens[27])
        x28 = types.Integer.from_mcnp(tokens[28])
        x29 = types.Integer.from_mcnp(tokens[29])
        x30 = types.Integer.from_mcnp(tokens[30])
        x31 = types.Integer.from_mcnp(tokens[31])
        x32 = types.Integer.from_mcnp(tokens[32])
        x33 = types.Integer.from_mcnp(tokens[33])
        x34 = types.Integer.from_mcnp(tokens[34])
        x35 = types.Integer.from_mcnp(tokens[35])
        x36 = types.Integer.from_mcnp(tokens[36])
        x37 = types.Integer.from_mcnp(tokens[37])
        x38 = types.Integer.from_mcnp(tokens[38])
        x39 = types.Integer.from_mcnp(tokens[39])
        x40 = types.Integer.from_mcnp(tokens[40])
        x41 = types.Integer.from_mcnp(tokens[41])
        x42 = types.Integer.from_mcnp(tokens[42])
        x43 = types.Integer.from_mcnp(tokens[43])
        x44 = types.Integer.from_mcnp(tokens[44])
        x45 = types.Integer.from_mcnp(tokens[45])
        x46 = types.Integer.from_mcnp(tokens[46])
        x47 = types.Integer.from_mcnp(tokens[47])
        x48 = types.Integer.from_mcnp(tokens[48])
        x49 = types.Integer.from_mcnp(tokens[49])
        x50 = types.Integer.from_mcnp(tokens[50])
        x51 = types.Integer.from_mcnp(tokens[51])
        x52 = types.Integer.from_mcnp(tokens[52])
        x53 = types.Integer.from_mcnp(tokens[53])
        x54 = types.Integer.from_mcnp(tokens[54])
        x55 = types.Integer.from_mcnp(tokens[55])
        x56 = types.Integer.from_mcnp(tokens[56])
        x57 = types.Integer.from_mcnp(tokens[57])
        x58 = types.Integer.from_mcnp(tokens[58])
        x59 = types.Integer.from_mcnp(tokens[59])
        x60 = types.Integer.from_mcnp(tokens[60])
        x61 = types.Integer.from_mcnp(tokens[61])
        x62 = types.Integer.from_mcnp(tokens[62])
        x63 = types.Integer.from_mcnp(tokens[63])
        x64 = types.Integer.from_mcnp(tokens[64])
        x65 = types.Integer.from_mcnp(tokens[65])
        x66 = types.Integer.from_mcnp(tokens[66])
        x67 = types.Integer.from_mcnp(tokens[67])
        x68 = types.Integer.from_mcnp(tokens[68])
        x69 = types.Integer.from_mcnp(tokens[69])
        x70 = types.Integer.from_mcnp(tokens[70])
        x71 = types.Integer.from_mcnp(tokens[71])
        x72 = types.Integer.from_mcnp(tokens[72])
        x73 = types.Integer.from_mcnp(tokens[73])
        x74 = types.Integer.from_mcnp(tokens[74])
        x75 = types.Integer.from_mcnp(tokens[75])
        x76 = types.Integer.from_mcnp(tokens[76])
        x77 = types.Integer.from_mcnp(tokens[77])
        x78 = types.Integer.from_mcnp(tokens[78])
        x79 = types.Integer.from_mcnp(tokens[79])
        x80 = types.Integer.from_mcnp(tokens[80])
        x81 = types.Integer.from_mcnp(tokens[81])
        x82 = types.Integer.from_mcnp(tokens[82])
        x83 = types.Integer.from_mcnp(tokens[83])
        x84 = types.Integer.from_mcnp(tokens[84])
        x85 = types.Integer.from_mcnp(tokens[85])
        x86 = types.Integer.from_mcnp(tokens[86])
        x87 = types.Integer.from_mcnp(tokens[87])
        x88 = types.Integer.from_mcnp(tokens[88])
        x89 = types.Integer.from_mcnp(tokens[89])
        x90 = types.Integer.from_mcnp(tokens[90])
        x91 = types.Integer.from_mcnp(tokens[91])
        x92 = types.Integer.from_mcnp(tokens[92])
        x93 = types.Integer.from_mcnp(tokens[93])
        x94 = types.Integer.from_mcnp(tokens[94])
        x95 = types.Integer.from_mcnp(tokens[95])
        x96 = types.Integer.from_mcnp(tokens[96])
        x97 = types.Integer.from_mcnp(tokens[97])
        x98 = types.Integer.from_mcnp(tokens[98])
        x99 = types.Integer.from_mcnp(tokens[99])
        x100 = types.Integer.from_mcnp(tokens[100])

        return DataOption_Dbcn(
            x1,
            x2,
            x3,
            x4,
