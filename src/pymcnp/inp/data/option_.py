...
class DataOption_(Option_):
    ...
    _REGEX = re.compile(
        ...
        rf'|ssw((?: {types.IntegerOrJump._REGEX.pattern})+?)((?: {types.IntegerOrJump._REGEX.pattern})+?)((?: (?:{ssw.SswOption_._REGEX.pattern}))+?)?'
        ...
        rf'|fm(\d+)( {types.String._REGEX.pattern})'
        ...
        rf'|ft(\d+)( {types.String._REGEX.pattern})'
