...
class DataOption_Pd(_option.DataOption_, keyword='pd'):
    """
    Represents INP data card pd options.
    ...
    def from_mcnp(source: str):
        """
        Generates ``DataOption_Pd`` from INP.
        ...
        tokens = DataOption_Pd._REGEX.match(source)
        ...
        return DataOption_Pd(probabilities, suffix, designator)
