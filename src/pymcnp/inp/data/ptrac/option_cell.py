...
class PtracOption_Cell(_option.PtracOption_, keyword='cell'):
    """
    ...
    def from_mcnp(source: str):
        """
        Generates ``PtracOption_Cell`` from INP.
        ...
        tokens = PtracOption_Cell._REGEX.match(source)
        ...
        return PtracOption_Cell(numbers)
