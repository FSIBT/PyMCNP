...
class EspltBuilder:
    ...
    energy_1: str | float | types.RealOrJump
    ratio_2: str | float | types.RealOrJump
    energy_2: str | float | types.RealOrJump
    ratio_3: str | float | types.RealOrJump
    energy_3: str | float | types.RealOrJump
    ratio_4: str | float | types.RealOrJump
    energy_4: str | float | types.RealOrJump
    ratio_5: str | float | types.RealOrJump
    energy_5: str | float | types.RealOrJump
    ratio_6: str | float | types.RealOrJump
    energy_6: str | float | types.RealOrJump
    ratio_7: str | float | types.RealOrJump
    energy_7: str | float | types.RealOrJump
    ratio_8: str | float | types.RealOrJump
    energy_8: str | float | types.RealOrJump
    ratio_9: str | float | types.RealOrJump
    energy_9: str | float | types.RealOrJump
    ratio_10: str | float | types.RealOrJump
    energy_10: str | float | types.RealOrJump
    ratio_11: str | float | types.RealOrJump
    energy_11: str | float | types.RealOrJump
    ratio_12: str | float | types.RealOrJump
    energy_12: str | float | types.RealOrJump
    ratio_13: str | float | types.RealOrJump
    energy_13: str | float | types.RealOrJump
    ratio_14: str | float | types.RealOrJump
    energy_14: str | float | types.RealOrJump
    ratio_15: str | float | types.RealOrJump
    energy_15: str | float | types.RealOrJump
    ratio_16: str | float | types.RealOrJump
    energy_16: str | float | types.RealOrJump
    ratio_17: str | float | types.RealOrJump
    energy_17: str | float | types.RealOrJump
    ratio_18: str | float | types.RealOrJump
    energy_18: str | float | types.RealOrJump
    ratio_19: str | float | types.RealOrJump
    energy_19: str | float | types.RealOrJump
    ratio_20: str | float | types.RealOrJump
    energy_20: str | float | types.RealOrJump
    ...
    def build(self):
        ...
        if isinstance(self.energy_1, types.Real):
            ...
            energy_1 = types.RealOrJump(self.energy_1)
        ...
        if isinstance(self.energy_2, types.Real):
            ...
            energy_2 = types.RealOrJump(self.energy_2)
        ...
        if isinstance(self.energy_3, types.Real):
            ...
            energy_3 = types.RealOrJump(self.energy_3)
        ...
        if isinstance(self.energy_4, types.Real):
            ...
            energy_4 = types.RealOrJump(self.energy_4)
        ...
        if isinstance(self.energy_5, types.Real):
            ...
            energy_5 = types.RealOrJump(self.energy_5)
        ...
        if isinstance(self.energy_6, types.Real):
            ...
            energy_6 = types.RealOrJump(self.energy_6)
        ...
        if isinstance(self.energy_7, types.Real):
            ...
            energy_7 = types.RealOrJump(self.energy_7)
        ...
        if isinstance(self.energy_8, types.Real):
            ...
            energy_8 = types.RealOrJump(self.energy_8)
        ...
        if isinstance(self.energy_9, types.Real):
            ...
            energy_9 = types.RealOrJump(self.energy_9)
        ...
        if isinstance(self.energy_10, types.Real):
            ...
            energy_10 = types.RealOrJump(self.energy_10)
        ...
        if isinstance(self.energy_11, types.Real):
            ...
            energy_11 = types.RealOrJump(self.energy_11)
        ...
        if isinstance(self.energy_12, types.Real):
            ...
            energy_12 = types.RealOrJump(self.energy_12)
        ...
        if isinstance(self.energy_13, types.Real):
            ...
            energy_13 = types.RealOrJump(self.energy_13)
        ...
        if isinstance(self.energy_14, types.Real):
            ...
            energy_14 = types.RealOrJump(self.energy_14)
        ...
        if isinstance(self.energy_15, types.Real):
            ...
            energy_15 = types.RealOrJump(self.energy_15)
        ...
        if isinstance(self.energy_16, types.Real):
            ...
            energy_16 = types.RealOrJump(self.energy_16)
        ...
        if isinstance(self.energy_17, types.Real):
            ...
            energy_17 = types.RealOrJump(self.energy_17)
        ...
        if isinstance(self.energy_18, types.Real):
            ...
            energy_18 = types.RealOrJump(self.energy_18)
        ...
        if isinstance(self.energy_19, types.Real):
            ...
            energy_19 = types.RealOrJump(self.energy_19)
        ...
        if isinstance(self.energy_20, types.Real):
            ...
            energy_20 = types.RealOrJump(self.energy_20)
        elif isinstance(self.energy_20, str):
            energy_20 = types.RealOrJump.from_mcnp(self.energy_20)
