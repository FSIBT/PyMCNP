...
class KpertOption_Cell(_option.KpertOption_, keyword='cell'):
    """
    ...
    def from_mcnp(source: str):
        """
        Generates ``KpertOption_Cell`` from INP.
        ...
        tokens = KpertOption_Cell._REGEX.match(source)
        ...
        return KpertOption_Cell(numbers)
