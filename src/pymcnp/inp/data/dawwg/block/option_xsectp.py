...
class BlockOption_Xsectp(_option.BlockOption_, keyword='xsectp'):
    """
    Represents INP data card data option dawwg option xsectp options.

    Attributes:
        setting: Cross-section print flag.
    """

    _REGEX = re.compile(r'\Axsectp( \S+)\Z')

    def __init__(self, setting: types.Integer):
        """
        Initializes ``BlockOption_Xsectp``.
    ...
    def from_mcnp(source: str):
        """
        Generates ``BlockOption_Xsectp`` from INP.
        ...
        tokens = BlockOption_Xsectp._REGEX.match(source)
        ...
        return BlockOption_Xsectp(setting)
