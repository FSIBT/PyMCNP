...
class TallyNps4(_block.Block):
    ...
    _REGEX = re.compile(
        ...
        r'                   cell: (.+)\n'
        r'                         (.+)\n \n'
        rf'((?:{tallynps.SubtallyNps4._REGEX.pattern[2:-2]})+)\n'
        r' ===================================================================================================================================\n\n'
    ...
    def __init__(
        ...
        subtallies: types.Tuple[tallynps.SubtallyNps1],
        ...
        if cell_value is None:
            raise errors.OutpError(errors.OutpCode.SEMANTICS_TABLE, cell_value)
        ...
        self.subtallies: typing.Final[types.Tuple[tallynps.SubtallyNps1]] = subtallies
    ...
    def from_mcnp(source: str):
        """
        Generates ``TallyNps4`` from OUTP.

        Parameters:
            source: OUTP for ``TallyNps4``.

        Returns:
            ``TallyNps4``.
        """

        tokens = TallyNps4._REGEX.match(source)
        ...
        subtallies = types.Tuple(
            [
                tallynps.SubtallyNps2.from_mcnp(token[0])
                for token in tallynps.SubtallyNps2._REGEX.finditer(tokens[7])
            ]
        )
