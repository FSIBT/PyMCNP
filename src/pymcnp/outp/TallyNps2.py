...
class TallyNps2(_block.Block):
    ...
    _REGEX = re.compile(
        ...
        r'                surface: (.+)\n'
        r'                         (.+)\n \n'
        rf'((?:{tallynps.SubtallyNps2._REGEX.pattern[2:-2]})+)\n'
        r' ===================================================================================================================================\n\n'
    ...
    def from_mcnp(source: str):
        """
        Generates ``TallyNps2`` from OUTP.

        Parameters:
            source: OUTP for ``TallyNps2``.

        Returns:
            ``TallyNps2``.
        """

        tokens = TallyNps2._REGEX.match(source)
