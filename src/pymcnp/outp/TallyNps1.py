...
class TallyNps1(_block.Block):
    ...
    def from_mcnp(source: str):
        """
        Generates ``TallyNps1`` from OUTP.

        Parameters:
            source: OUTP for ``TallyNps1``.

        Returns:
            ``TallyNps1``.
        """

        tokens = TallyNps1._REGEX.match(source)
