"""
Contains the ``Pd`` subclass of ``Data``.
"""
...
class Pd(Data):
    ...
    def __init__(
        ...
        self.mnemonic: Final[DataMnemonic] = DataMnemonic.PD
        ...
        self.ident: Final[str] = f'pd{self.suffix}:{self.designator}'
    ...
    def from_mcnp(source: str):
        ...
        data = Pd(probabilities, suffix, designator)
