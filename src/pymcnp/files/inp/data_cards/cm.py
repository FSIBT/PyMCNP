"""
Contains the ``Cm`` subclass of ``Data``.
"""
...
class Cm(Data):
    ...
    def __init__(self, multipliers: tuple[types.McnpReal], suffix: types.McnpInteger):
        ...
        self.mnemonic: Final[DataMnemonic] = DataMnemonic.CM
        ...
        self.ident: Final[str] = f'cm{self.suffix}'

    @staticmethod
    def from_mcnp(source: str):
        """
        Generates ``Cm`` objects from INP.

        ``from_mcnp`` translates from INP to PyMCNP; it parses INP.

        Parameters:
            source: INP for cm data cards.
