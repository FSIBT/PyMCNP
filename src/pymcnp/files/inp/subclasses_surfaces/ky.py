"""
Contains the ``Ky`` subclass of ``Surface``.
"""
...
class Ky(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.KY
        ...
        self.parameters: Final[tuple[types.McnpReal]] = tuple([y, t_squared, plusminus_1])

    @staticmethod
    def from_mcnp(source: str):
        """
        Generates ``Ky`` objects from INP.
