...
class Kz(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.KZ
        ...
        self.parameters: Final[tuple[types.McnpReal]] = tuple([z, t_squared, plusminus_1])

    @staticmethod
    def from_mcnp(source: str):
        """
        Generates ``Kz`` objects from INP.
    ...
    def to_pyvista(self):
        """
        Generates ``pyvista.PolyData`` representing ``Kz``.
