"""
Contains the ``Kx`` subclass of ``Surface``.
"""
...
class Kx(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.KX
        ...
        self.parameters: Final[tuple[types.McnpReal]] = tuple([x, t_squared, plusminus_1])

    @staticmethod
    def from_mcnp(source: str):
        """
        Generates ``Kx`` objects from INP.
    ...
    def to_pyvista(self):
        """
        Generates ``pyvista.PolyData`` representing ``Kx``.
