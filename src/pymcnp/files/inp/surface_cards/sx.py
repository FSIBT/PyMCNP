"""
Contains the ``Sx`` subclass of ``Surface``.
"""
...
class Sx(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.SX
        ...
        self.parameters: Final[tuple[types.McnpReal]] = tuple([x, r])

    @staticmethod
    def from_mcnp(source: str):
        """
        Generates ``Sx`` objects from INP.
