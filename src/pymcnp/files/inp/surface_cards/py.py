"""
Contains the ``Py`` subclass of ``Surface``.
"""
...
class Py(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.PY
    ...
    def to_pyvista(self):
        """
        Generates ``pyvista.PolyData`` representing ``Py``.
