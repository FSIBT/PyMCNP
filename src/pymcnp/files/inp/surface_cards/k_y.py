"""
Contains the ``K_y`` subclass of ``Surface``.
"""
...
class K_y(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.K_Y
    ...
    def from_mcnp(source: str):
        """
        Generates ``K_y`` objects from INP.
    ...
    def to_pyvista(self):
        """
        Generates ``pyvista.PolyData`` representing ``K_y``.
