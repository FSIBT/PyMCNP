"""
Contains the ``Cz`` subclass of ``Surface``.
"""
...
class Cz(Surface):
    ...
    def __init__(
        ...
        self.mnemonic: Final[SurfaceMnemonic] = SurfaceMnemonic.CZ
    ...
    def to_pyvista(self):
        """
        Generates ``pyvista.PolyData`` representing ``Cz``.
