...
class HistoryLine_J_1(_line.HistoryLine_):
    """
    ...
    def from_mcnp(source: str):
        """
        Generates ``HistoryLine_J_1`` from PTRAC.

        Parameters:
            source: PTRAC for ``HistoryLine_J_1``.
        ...
        tokens = HistoryLine_J_1._REGEX.match(source)
