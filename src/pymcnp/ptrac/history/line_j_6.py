...
class HistoryLine_J_6(_line.HistoryLine_):
    """
    ...
    def from_mcnp(source: str):
        """
        Generates ``HistoryLine_J_6`` from PTRAC.

        Parameters:
            source: PTRAC for ``HistoryLine_J_6``.
        ...
        tokens = HistoryLine_J_6._REGEX.match(source)
