...
class HistoryLine_J_2(_line.HistoryLine_):
    """
    ...
    def from_mcnp(source: str):
        """
        Generates ``HistoryLine_J_2`` from PTRAC.

        Parameters:
            source: PTRAC for ``HistoryLine_J_2``.
        ...
        tokens = HistoryLine_J_2._REGEX.match(source)
